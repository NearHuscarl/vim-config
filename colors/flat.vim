...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
	...
	hi Folded             ctermfg=7    ctermbg=NONE guifg=#84888B guibg=#1F2D3A cterm=NONE      gui=NONE
	hi MatchParen         ctermfg=11   ctermbg=0    guifg=#F1C40F guibg=#1F2D3A cterm=NONE      gui=NONE
	hi SignColumn         ctermfg=7    ctermbg=NONE guifg=#84888B guibg=#1F2D3A cterm=NONE      gui=NONE
	...
	hi SpellBad           ctermfg=1    ctermbg=NONE guifg=#C0392B guibg=NONE    cterm=underline gui=underline
	hi SpellCap           ctermfg=14   ctermbg=NONE guifg=#2AA198 guibg=NONE    cterm=underline gui=underline
	hi SpellLocal         ctermfg=2    ctermbg=NONE guifg=#27AE60 guibg=NONE    cterm=underline gui=underline
	hi SpellRare          ctermfg=9    ctermbg=NONE guifg=#E74C3C guibg=NONE    cterm=underline gui=underline
	...
	hi Fzf_Highlight      ctermfg=3    ctermbg=NONE guifg=#F39C12 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_ForegroundPlus ctermfg=NONE ctermbg=NONE guifg=NONE    guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_BackgroundPlus ctermfg=8    ctermbg=NONE guifg=#2C3E50 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_HighlightPlus  ctermfg=9    ctermbg=NONE guifg=#E74C3C guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Info           ctermfg=6    ctermbg=NONE guifg=#16A085 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Border         ctermfg=6    ctermbg=NONE guifg=#16A085 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Prompt         ctermfg=NONE ctermbg=NONE guifg=NONE    guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Pointer        ctermfg=6    ctermbg=NONE guifg=#16A085 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Marker         ctermfg=5    ctermbg=NONE guifg=#8E44AD guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Spinner        ctermfg=6    ctermbg=NONE guifg=#16A085 guibg=NONE    cterm=NONE      gui=NONE
	hi Fzf_Header         ctermfg=NONE ctermbg=NONE guifg=NONE    guibg=NONE    cterm=NONE      gui=NONE
	hi ALEErrorSign       ctermfg=9    ctermbg=NONE guifg=#E74C3C guibg=NONE    cterm=NONE      gui=NONE
	hi ALEWarningSign     ctermfg=3    ctermbg=NONE guifg=#F39C12 guibg=NONE    cterm=NONE      gui=NONE
	hi ALEInfoSign        ctermfg=4    ctermbg=NONE guifg=#2980B9 guibg=NONE    cterm=NONE      gui=NONE
endif
